...
export function LibroCard({ libro, onUpdate }: LibroCardProps) {
  ...
  const handlePrestar = async () => {
    if (!usuario || usuario.tipo !== "bibliotecario") return
      ...
      <CardContent>
        <div className="space-y-3">
          ...
          <div className="flex gap-2 pt-2">
            {libro.copiasDisponibles > 0 && usuario?.tipo === "bibliotecario" && (
